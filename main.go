...
import (
	...
	"github.com/mhrivnak/agentinstalloperator/controllers"
...
func init() {
	...
	utilruntime.Must(installopenshiftiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6858b147.install.openshift.io",
	})
	if err != nil {
